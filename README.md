# Kalkulusbot - Telegram Kalkulus Tipbot.
 
#### Kalkulus crypto currency tipbot for [Telegram](https://telegram.org)
...
* In order to run the tip-bot effectively, a Kalkulus core based client is needed. For this git Kalkulus-Core is used , but any major alternate crypto-currency client could easily be incorperated. 
